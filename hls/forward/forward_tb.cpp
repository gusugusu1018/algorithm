...
data_t f_data[N_INPUT];
data_t f_w01[N_INPUT*N_H1];
data_t f_b1[N_H1];
data_t f_w12[N_H1*N_H2];
data_t f_b2[N_H2];
data_t f_w23[N_H2*N_OUTPUT];
data_t f_b3[N_OUTPUT];
...
int main(){
   ...
   //forward_cpu(src_data,data,w01,b1,w12,b2,w23,b3);
   forward_fixed(src_data,f_data,f_w01,f_b1,f_w12,f_b2,f_w23,f_b3);
   for (i=0;i<10;i++)std::cout<<i<<" "<<f_data[i]<<std::endl;
