...
#define BARO_VEL_THRESHOLD_MAX 1.0f
#define BARO_VEL_THRESHOLD_MIN -1.0f

#define BARO_VEL_FILTER_TAU	0.0025f
#define BARO_VEL_FILTER_FC	12.0f

#define BARO_ACC_THRESHOLD_MAX 1.5f
#define BARO_ACC_THRESHOLD_MIN -1.5f
...
main() {
	...
	while (std::getline(ifs,str)) {
		...
		// print
		std::cout << newtime << "\t" << filtered_baro_acc << std::endl;
		ofs << newtime << "\t" << filtered_baro_acc << std::endl;
		// update old value
		oldtime = newtime;
		baro_alt_old = baro_alt;
